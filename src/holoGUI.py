...
sys.path.append(str(Path('../../Cam Acq Sys/src')))
sys.path.append(str(Path('../../Cam Acq Sys/src/widgets')))
sys.path.append(str(Path('../../Cam Acq Sys/src/cameras')))
sys.path.append(str(Path('../../Cam Acq Sys/src/threads')))
sys.path.append(str(Path('../../Cam Acq Sys/src/threads')))
